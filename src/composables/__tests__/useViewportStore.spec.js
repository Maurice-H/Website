...
describe('useViewportStore', () => {
    ...
    it('should update offsets when requested', () => {
        ...
        // First call
        mockEl.getBoundingClientRect.mockReturnValue({
            left: 10,
            top: 20,
        });
        update();
    ...
    describe('init', () => {
        ...
        it('should update offsets on resize/scroll events', async () => {
            ...
            mockEl.getBoundingClientRect.mockReturnValue({ left: 300, top: 400 });
            ...
            mockEl.getBoundingClientRect.mockReturnValue({ left: 500, top: 600 });
    ...
    describe('updateAll exception conditions part 2', () => {
        ...
        it('should ignore entries without visible elements', async () => {
            ...
            if (reg)
                reg.isVisible = false;
            mockEl.getBoundingClientRect.mockClear();
            window.dispatchEvent(new Event('scroll'));
            await new Promise((resolve) => requestAnimationFrame(resolve));
