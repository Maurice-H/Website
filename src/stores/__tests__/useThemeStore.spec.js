...
describe('useThemeStore extensions', () => {
    ...
    describe('localStorage persistence', () => {
        ...
        it('persists lightingEnabled to localStorage when it changes', async () => {
            ...
            await nextTick();
            expect(window.localStorage.setItem).toHaveBeenCalledWith('portfolio-lighting-enabled', 'false');
            store.lightingEnabled = true;
            await nextTick();
            expect(window.localStorage.setItem).toHaveBeenCalledWith('portfolio-lighting-enabled', 'true');
        });
