...
const { playGlitch: playSwitchSound } = useAudio();
const toggleTheme = () => {
...
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
    ...
    type: "button",
    'aria-label': (`System Mode ${__VLS_ctx.isBlueprint ? 'Blueprint' : 'Finished'}`),
    ...
    'aria-pressed': (__VLS_ctx.isBlueprint),
});
...
const __VLS_0 = ThemeToggleIcon;
// @ts-ignore
const __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0({
    isBlueprint: (__VLS_ctx.isBlueprint),
}));
...
(__VLS_ctx.isBlueprint ? "Blueprint" : "Finished");
// @ts-ignore
[toggleTheme, isBlueprint, isBlueprint, isBlueprint, isBlueprint, isBlueprint,];
