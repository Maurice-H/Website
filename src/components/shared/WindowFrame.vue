<template>
  <div class="window-frame-container h-full flex flex-col">
    ...
    <!-- Window Content -->
    <div class="window-content-area flex-1 overflow-auto relative px-6 pb-6 pt-2">
      <slot></slot>
    </div>
  </div>
</template>
...
.window-title {
  /* Clean text without heavy shadows to match subpage vision */
