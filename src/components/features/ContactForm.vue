<template>
  ...
  >
    <div class="p-4 md:p-10 flex flex-col h-full">
      ...
      >
        <div class="text-finished-accent w-12 h-12">
          <DiscordIcon />
        </div>
...
import { DiscordIcon, EmailIcon, LinkedinIcon, XingIcon } from '../shared/icons';
...
const channels: { id: ChannelId; label: string; icon: Component }[] = [
  { id: 'email', label: 'Email', icon: markRaw(EmailIcon) },
  { id: 'discord', label: 'Discord', icon: markRaw(DiscordIcon) },
  { id: 'xing', label: 'Xing', icon: markRaw(XingIcon) },
  { id: 'linkedin', label: 'LinkedIn', icon: markRaw(LinkedinIcon) },
];
