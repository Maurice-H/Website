<template>
  ...
  >
    <div class="p-4 md:p-10 flex flex-col h-full">
      ...
      >
        <IconDiscord class="text-finished-accent w-12 h-12" />
      ...
      <div
        ...
        class="flex flex-col items-center justify-center flex-1 gap-4 py-8"
      >
        <IconXing class="text-finished-accent w-12 h-12" />
        <p class="text-finished-text/50 text-sm text-center">
      ...
      <div
        ...
        class="flex flex-col items-center justify-center flex-1 gap-4 py-8"
      >
        <IconLinkedIn class="text-finished-accent w-12 h-12" />
        <p class="text-finished-text/50 text-sm text-center">
...
import { IconDiscord, IconEmail, IconLinkedIn, IconXing } from '../shared/icons';
...
const channels: { id: ChannelId; label: string; icon: any }[] = [
  { id: 'email', label: 'Email', icon: markRaw(IconEmail) },
  { id: 'discord', label: 'Discord', icon: markRaw(IconDiscord) },
  { id: 'xing', label: 'Xing', icon: markRaw(IconXing) },
  { id: 'linkedin', label: 'LinkedIn', icon: markRaw(IconLinkedIn) },
];
