import{A as e,F as t,I as n,L as r,N as i,P as a,Q as o,U as s,V as c,X as l,Y as u,Z as d,_ as f,_t as p,a as ee,b as m,c as te,d as ne,f as re,ft as h,g as ie,gt as g,h as ae,i as oe,l as se,m as _,n as ce,nt as le,o as ue,p as v,pt as y,r as de,rt as b,s as x,t as fe,tt as pe,u as me,v as he,vt as S,x as C,y as w,yt as T,z as E}from"./three-vendor-CnuGiQxz.js";import{n as ge,t as _e}from"./usePerformanceStore-BdTHRkMh.js";import{a as D,i as ve,n as ye,r as be,t as xe}from"./index-CwXZByrA.js";var Se={class:`ufo-body`},Ce={key:0,class:`ufo-glow`},O={class:`drone-x`},we={class:`drone-y`},k={class:`drone-scale`},A={class:`drone-rotate`},j={class:`drone-body`},M={key:0,class:`drone-pulse`},N={class:`css-particles`},P=D(c({__name:`CSSBackground`,setup(t){let s=be(),c=xe(),l=i(()=>s.phase===ve.NAV),u=i(()=>s.phase===ve.CONTENT),f=i(()=>c.lightingEnabled),ee=i(()=>c.isBlueprintMode),m=e=>{let t=e*1.3%6,n=4+e%4,r=e*8.3%100,i=e*7.1%100,a=2+e%3;return{"--p-delay":`${t}s`,"--p-duration":`${n}s`,left:`${r}%`,top:`${i}%`,width:`${a}px`,height:`${a}px`}};return(t,i)=>(d(),r(`div`,{class:p([`css-background`,{"phase-content":u.value}])},[a(`div`,{class:p([`css-ufo`,{"ufo-visible":l.value,"ufo-blueprint":ee.value}])},[a(`div`,Se,[i[0]||=a(`div`,{class:`ufo-dome`},null,-1),i[1]||=a(`div`,{class:`ufo-hull`},null,-1),i[2]||=a(`div`,{class:`ufo-ring`},null,-1),f.value?(d(),r(`div`,Ce)):n(``,!0)])],2),a(`div`,{class:p([`css-drone`,{"drone-visible":u.value,"drone-blueprint":ee.value}])},[a(`div`,O,[a(`div`,we,[a(`div`,k,[a(`div`,A,[a(`div`,j,[f.value?(d(),r(`div`,M)):n(``,!0),i[3]||=a(`div`,{class:`drone-base`},null,-1),i[4]||=a(`div`,{class:`drone-core`},null,-1),i[5]||=a(`div`,{class:`drone-ring`},null,-1),f.value?(d(),r(e,{key:1},o(8,e=>a(`div`,{key:e,class:`drone-light`,style:T({"--dot-angle":e*45+`deg`,animationDelay:e*.2+`s`})},null,4)),64)):n(``,!0)])])])])])],2),a(`div`,N,[(d(),r(e,null,o(12,e=>a(`span`,{key:e,class:`particle`,style:T(m(e))},null,4)),64))])],2))}}),[[`__scopeId`,`data-v-609818f2`]]),Te=`uniform vec2 uMouse;
...
`,F=new C;function De(e,t,n){F.copy(e).project(t);let r=(F.x+1)/2,i=(F.y+1)/2;return n?n.set(r,i):new m(r,i)}var Oe=[`position`],ke={"render-order":-1},Ae=[`vertex-shader`,`fragment-shader`],je=[`object`],Me={key:1,scale:[.3,.3,.3]},Ne=[`rotation`],Pe=[`color`],Fe=[`object`,`rotation`],Ie={key:1,scale:[.15,.15,.15]},Le=[`rotation`],Re=[`color`],ze={position:[.27,.26,-.1]},Be=[`color`,`angle`],Ve={position:[-.78,-.67,1.2],rotation:[5,0,0]},He={key:0,args:[.4,3,16,1,!0]},Ue=[`position`,`a-velocity`],We=.8,Ge=.3,Ke=15,qe=.82,Je=3.2,Ye=20,Xe=3,Ze=`
  uniform float uTime;
