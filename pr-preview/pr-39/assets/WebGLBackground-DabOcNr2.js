import{$ as e,B as t,D as n,F as r,O as i,R as a,T as o,Y as s,_ as c,a as ee,b as l,c as u,d,f,h as p,i as m,l as h,mt as g,n as _,o as v,r as y,s as b,t as x,u as S,v as C,x as w,z as T}from"./three-vendor-DahUnWlF.js";import{i as E,n as te,r as D,t as O}from"./index-Ce2vglV0.js";var k=`uniform vec2 uMouse;
...
`,j=new f;function M(e,t,n){j.copy(e).project(t);let r=(j.x+1)/2,i=(j.y+1)/2;return n?n.set(r,i):new d(r,i)}var N=[`position`],P={"render-order":-1},F=[`vertex-shader`,`fragment-shader`],I=[`rotation`],L=[`color`],R=[`rotation`],z=[`color`],B=n({__name:`WebGLScene`,setup(t){let n=E(),i=c(()=>n.gpuTier&&n.gpuTier>=3),o=s(),l=s(),f=s(),g=s(),v=D(),S=O(),j=te(),B=c(()=>S.isBlueprintMode?`#38bdf8`:`#10b981`),{renderer:V,scene:H,camera:U,sizes:W}=u(),G=null,K=null,q=null,ne={uniforms:{tDiffuse:{value:null},amount:{value:.005},angle:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
